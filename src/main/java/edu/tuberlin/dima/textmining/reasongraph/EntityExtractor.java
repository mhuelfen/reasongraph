...
public class EntityExtractor {
    ...
    public String convertParseToSynNgram(DependencyParse parse) {
        ...
        for (DepWord word : parse.getWords()) {
            ...
            if (!word.getPosTag().equals(".")) {
                ...
                synNgram += word.getWordName().toLowerCase() + "/" + word.getPosTag() + "/";
            ...
            if (word.getPosTag().startsWith("VB")) {
                mainVerb = word.getWordName().toLowerCase();
            }
    ...
    public SyntacticVerbGram sentenceToSynNgrams(String ngramLine) throws Exception {
        ...
        // from alans code
        // ngramLine =
        // "obscured\twhen//compl/5 the/DT/det/3 sun/NN/nsubjpass/5 is/VBZ/aux/5 obscured/VBN/ccomp/0 by/IN/prep/5 cloud/NN/pobj/6";
